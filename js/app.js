 ...
 * Versión Estable: Se elimina el módulo de historias para restaurar la funcionalidad.
 * =========================================================================
 */
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Plantilla solo para el video destacado
    ...
    function displayPosts(posts) {
        ...
        // Insertamos el video destacado al principio del contenido dinámico.
    ...
    function openSidePanel(cardElement) {
        ...
        // Solo verificamos por el video destacado, ya que las historias no existen
