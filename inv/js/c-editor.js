    ...
    initializeEditor() {
        return new Promise(resolve => {
            this.editorInstance = new EditorJS({
                holder: 'editorjs', // El ID del div que creamos en el HTML
                placeholder: 'Escribe tu artículo aquí... Presiona "Tab" para abrir el menú o "+" para añadir bloques.',
                
                // Aquí configuramos las herramientas que tendrá el autor
                tools: {
                    header: {
                        class: Header,
                        inlineToolbar: true,
                    ...
                    // EL PUENTE MÁGICO A IMGBB
                    image: {
                        class: ImageTool,
                        config: {
                            uploader: {
                                uploadByFile: async (file) => {
                                    // Cuando el usuario sube o arrastra una foto, interceptamos aquí
                                    ...
                                    try {
                                        ...
                                        // Le devolvemos a Editor.js el link limpio de la nube
                                        return {
                                            success: 1,
                ...
                onChange: () => {
                    // Si el usuario escribe algo, disparamos el autoguardado (lo arreglaremos en el siguiente paso)
